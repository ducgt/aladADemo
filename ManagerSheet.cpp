   ...
   switch(wParam)
     {
      ...
      case PUMP_UPDATE_BIDASK:
		  m_main.PostMessage(ExtPumpingMsg, PUMP_UPDATE_BIDASK);
      ...
      case PUMP_UPDATE_USERS:
		 ...
		 m_main.PostMessage(ExtPumpingMsg,PUMP_UPDATE_USERS);
      ...
      case PUMP_UPDATE_TRADES:
		 ...
		 m_main.PostMessage(ExtPumpingMsg, PUMP_UPDATE_TRADES);
      ...
      case PUMP_UPDATE_MARGINCALL:
		 ...
		 m_main.PostMessage(ExtPumpingMsg, PUMP_UPDATE_MARGINCALL);
